...
CV_Fast_PD::CV_Fast_PD( int numpoints, int numlabels, Real *lcosts,
...
void CV_Fast_PD::init_duals_primals( void )
{
    printf( "Initializing..." );
...
void CV_Fast_PD::inner_iteration( Graph::Label label )
{
    int i;
...
void CV_Fast_PD::inner_iteration_adapted( Graph::Label label )
{
    if ( _iter > 1 )
...
void CV_Fast_PD::track_source_linked_nodes( Graph::Label label )
{
    int i;
    assert( _iter > 1 );
...
void CV_Fast_PD::fillGraph( Graph *_graph )
{
    _graph->add_nodes();
    _graph->add_edges( _pairs, _numpairs );
}

void CV_Fast_PD::createNeighbors( void )
{
...
double CV_Fast_PD::MAX( double a, double b ) { return ( a >= b ? a : b ); }
double CV_Fast_PD::MIN( double a, double b ) { return ( a <= b ? a : b ); }

Graph::Label CV_Fast_PD::getLabel( int position )
{
